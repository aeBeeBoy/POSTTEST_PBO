        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    // Pemanggilan method interface
                    if (siswaBaru instanceof AktivitasBelajar) {
                        ((AktivitasBelajar) siswaBaru).mulaiBelajar();
                    }
                    break;
                ...
                case 3:
                    ...
                    System.out.println("Jenis siswa yang akan diupdate:");
                    System.out.println("1. Reguler");
                    System.out.println("2. Privat");
                    System.out.print("Pilih : ");
                    ...
                    if (jenisUpdate == 1) {
                        ...
                        kursus.updateSiswa(idUpdate, namaBaru, umurBaru, levelBaru, alamatBaru, jumlahBaru);
                    } else {
                        System.out.print("Tutor baru : ");
                        String tutorBaru = input.nextLine();

                        kursus.updateSiswa(idUpdate, namaBaru, umurBaru, levelBaru, alamatBaru, tutorBaru);
                    }
                    break;
